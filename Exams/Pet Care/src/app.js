...
const navigationContainer = document.querySelector('body>header')
const pageContainer = document.querySelector('body>main')
...
// page('/mine', views.myItemsView)
//
page('/donate/:postId', views.donateView)
page.start()
