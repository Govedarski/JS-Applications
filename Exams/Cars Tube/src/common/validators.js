...
export const checkAddressMinLength = checkMinLength.bind(null, ADDRESS_MIN_LENGTH);
export const checkPhoneMinLength = checkMinLength.bind(null, PHONE_MIN_LENGTH);
...
export const checkIsPositive = checkMinValue.bind(null, 0);
