(function (global, factory) {
    ...
    const data = fs__default['default'].existsSync('./requests') ? fs__default['default'].readdirSync('./requests').reduce((p, c) => {
        const content = JSON.parse(fs__default['default'].readFileSync('./requests/' + c));
    ...
    /**
     * Create storage instance and populate with seed requests
     * @param {Object=} seedData Associative array with requests. Each property is an object with properties in format {key: value}
     */
    function createInstance(seedData = {}) {
        const collections = new Map();

        // Initialize seed requests from file
